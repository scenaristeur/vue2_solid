...
var __vue_render__$6 = function () {
  ...
  return _c("span", { staticClass: "login" }, [
    _c(
      ...
      {
        staticClass:
          "mx-2 px-2 py-1 text-xs rounded text-gray-800 border focus:outline-none hover:bg-gray-100",
      },
      [_vm._v("Default")]
    ),
    _vm._v(" "),
    _c(
      ...
      {
        staticClass:
          "mx-2 px-4 py-2 text-sm rounded text-white bg-red-500 focus:outline-none hover:bg-red-400",
      },
      [_vm._v("Danger")]
    ),
    _vm._v(" "),
    _c(
      ...
      {
        staticClass:
          "mx-2 px-4 py-2 text-sm text-blue-600 focus:outline-none hover:underline",
      },
      [_vm._v("Link")]
    ),
    _vm._v(" "),
